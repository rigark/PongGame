...
public class Window extends JFrame implements Runnable {
   ...
   public boolean isRunning = true;
    ...
    public Window() {
        ...
        leftScoreText = new Text(0, new Font("Times New Roman",Font.PLAIN,Constants.TEXT_SIZE),Constants.TEXT_X_POS,Constants.TEXT_V_POS);
        rightScoreText = new Text(0,
                new Font("Times New Roman",Font.PLAIN,Constants.TEXT_SIZE),
                Constants.SCREEN_WIDTH - Constants.TEXT_X_POS - 16,Constants.TEXT_V_POS);
