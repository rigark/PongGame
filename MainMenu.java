...
public class MainMenu extends JFrame implements Runnable {
    ...
    public MainMenu() {
        ...
        this.pong = new Text("•Welcome to Pong game•",new Font("Times New Roman",Font.PLAIN,60),Constants.SCREEN_WIDTH/2.0-360,200,Color.WHITE);
    ...
    public void update(double dt){
        ...
        mouseListener.getMouseY() > startGame.y - startGame.height/2 && mouseListener.getMouseY() < startGame.y + startGame.height/2.0) {
         startGame.color = new Color(114, 11, 21);
        ...
        if (mouseListener.getMouseX() > exitGame.x && mouseListener.getMouseX() < exitGame.x + exitGame.width &&
            ...
            exitGame.color = new Color(114, 11, 21);
        if (mouseListener.isMousePressed()){
            Main.changeState(2);
        }
        } else{
